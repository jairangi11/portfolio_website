  ...
  return (
    <header 
      className={cn(
        ...
        scrolled 
          ? "bg-background/80 backdrop-blur-md border-b border-border/30 py-3" 
          : "bg-transparent py-5"
      )}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
                ...
                <li key={item.href} className="relative">
                  <Link href={item.href} target={item.isExternal ? "_blank" : undefined}>
                    ...
                    >
                      ...
                      {item.isExternal && <FiExternalLink className="ml-1 h-3 w-3" />}
          ...
          >
            <div className="h-10 w-10 flex items-center justify-center rounded-full bg-primary/10 text-primary hover:bg-primary/20 transition-colors">
