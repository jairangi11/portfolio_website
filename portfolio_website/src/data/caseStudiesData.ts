...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    challenge: "The traditional prior authorization process was manual, time-consuming for healthcare providers, and often led to delays in patient care. Ensuring data security and compliance with HIPAA regulations throughout the workflow was paramount.",
    solution: "I spearheaded the product development of a new platform that integrated with provider EHR systems via secure APIs (e.g., FHIR). The platform used NLP to pre-process requests, AI to check against payer rulesets, and provided a streamlined interface for human reviewers for complex cases. Robust audit trails and role-based access controls were implemented for compliance.",
    approach: "Engaged deeply with clinical reviewers, provider office staff, and compliance officers to map existing workflows and pain points. Employed an iterative development cycle, focusing first on secure data ingestion and core rules engine development. Prioritized user experience for both providers submitting requests and internal reviewers.",
    results: "Reduced average prior authorization turnaround time by 35%. Decreased manual processing effort by 50% for standard cases. Improved provider satisfaction scores related to the prior authorization process by 20%. Maintained 100% compliance with HIPAA data handling requirements.",
    learnings: "Successfully navigating enterprise health tech requires balancing user efficiency gains with non-negotiable security and compliance requirements. Deep integration with existing clinical systems and understanding complex regulatory landscapes are critical success factors. Cross-functional collaboration with clinical and legal teams is essential.",
    figmaLink: "https://www.google.com",
    whimsicalLink: "https://www.google.com",
    sheetsLink: "https://www.google.com"
  }
